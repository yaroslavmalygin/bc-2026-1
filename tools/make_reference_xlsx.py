...
# Даты, названные астрологом, главнее расчёта. Средняя синодическая модель
# промахивается на несколько часов, и промах на сутки у края диапазона
# особенно дорог: фаза либо попадает в таблицу, либо выпадает наружу и
# становится опорой — а это разные вещи.
#
#   август 2026 — размечен в настоящей таблице: новолуние 12-го (то самое
#     полное солнечное затмение), полнолуние 28-го; модель дала 13-е;
#   31 августа 2027 — новолуние в последний день диапазона; модель
#     перебросила его на 1 сентября, то есть наружу, и хвост календаря
#     остался без опоры.
MOON_OVERRIDES = {
    date(2026, 8, 12): "new",
    date(2026, 8, 28): "full",
